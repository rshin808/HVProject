...
home = Page(getIP(), [Box1("Channel 1", 0, 0, font14h, (255, 255), (0, 0), 10, 26, 1, 0), Box1("Channel 2", 0, 0, font14h, (255, 255), (0, 0), 10, 80, 2, 0)], 0)
ch1 = Page(getIP(), [Box1("Channel 1", 0, 0, font14h, (255, 255), (0, 0), 10, 26, 0, 1), Box1("Channel 2", 0, 0, font14h, (255, 255), (0, 0), 10, 80, 2, 1)], 0)
ch2 = Page(getIP(), [Box1("Channel 1", 0, 0, font14h, (255, 255), (0, 0), 10, 26, 0, 2), Box1("Channel 2", 0, 0, font14h, (255, 255), (0, 0), 10, 80, 1, 2)], 0)
...
try:
    ...
    while(True):
        ...
        if (now - checkTime) >= 0.005:
            ...
            params = [[readings[0], 5.0], [readings[1], 5.0]] 
            i = 0
