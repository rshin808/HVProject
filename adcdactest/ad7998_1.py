...
class ad7998_1:
    ...
    def __init_adc(self, bus):
        ...
        for dummy_index in range(2 * self._channels_EN):
            ...
            if(self.get_channel(data1[:4]) <= lowest):
    ...
    def get_data(self, bus):
        while(True):
            ...
            if(self.get_channel(data1[:4]) == lowest):
                ...
                voltage[self.get_channel(data1[:4])] =  self.__int_to_volt(int(voltage_bin, 2))
                break;
